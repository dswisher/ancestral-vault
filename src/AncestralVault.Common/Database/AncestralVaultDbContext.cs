...
namespace AncestralVault.Common.Database
{
    public class AncestralVaultDbContext : DbContext
    {
        ...
        public virtual DbSet<Persona> Personae { get; init; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Assertion>(entity =>
            {
                ...
                entity.ToTable(t => t.HasCheckConstraint(
                    ...
                    "(CASE WHEN subject1_persona_id IS NOT NULL THEN 1 ELSE 0 END + " +
                    "CASE WHEN subject1_event_id IS NOT NULL THEN 1 ELSE 0 END + " +
                    "CASE WHEN subject1_characteristic_id IS NOT NULL THEN 1 ELSE 0 END + " +
                    "CASE WHEN subject1_group_id IS NOT NULL THEN 1 ELSE 0 END) = 1"
                ));
            });
        }
    }
